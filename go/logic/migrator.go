...
import (
	...
	"github.com/yuddpky/gh-ost/go/base"
	"github.com/yuddpky/gh-ost/go/binlog"
	"github.com/yuddpky/gh-ost/go/mysql"
	"github.com/yuddpky/gh-ost/go/sql"
...
func (this *Migrator) waitForEventsUpToLock() (err error) {
	...
	for found := false; !found; {
		...
		case <-timeout.C:
			{
				log.Error("Timeout while waiting for events up to lock")
